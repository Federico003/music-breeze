...
@if ($role == 'admin')
    <nav x-data="{ open: false }" class="bg-orange-400 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex justify-between h-16 ">
                <div class="flex">
                    ...
                    <div class="hidden sm:-my-px sm:ms-10 sm:flex">
                        ...
                        <x-nav-link :href="route('admin.courses')" :active="request()->routeIs('courses')">
                            {{ __('CORSI') }}
                        </x-nav-link>

                        <x-nav-link :href="route('admin.students')" :active="request()->routeIs('students')">
                            {{ __('STUDENTI') }}
                        </x-nav-link>

                        <x-nav-link :href="route('admin.teachers')" :active="request()->routeIs('teachers')">
                            {{ __('INSEGNANTI') }}
                        </x-nav-link>

                        <x-nav-link :href="route('admin.other-users')" :active="request()->routeIs('otherUser')">
                            {{ __('ALTRI UTENTI') }}
                        </x-nav-link>
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6 ">
                    ...
                    <button id="theme-toggle" type="button"
                        class="text-white dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors duration-300  rounded-lg text-sm p-2.5">
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            {{-- <x-dropdown-link :href="route('admin.profile.view')">
                                {{ __('Profile') }}
                            </x-dropdown-link> --}}
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 ">
                <div class="flex">
                    <!-- Logo -->
                    <div class="shrink-0 flex items-center">
                        <a href="{{ route('insegnante.dashboard') }}">
                            {{-- <x-application-logo class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" /> --}}
                            <img src="{{ asset('images/logo_rma.png') }}" alt="Logo dell'azienda" class="w-14 h-auto">
