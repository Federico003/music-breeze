        ...
        <div class="space-y-4 m-4">
            @foreach ($teachers as $index => $teacher)
                <div x-data="{ open: false }" class="rounded-lg shadow dark:bg-gray-700 bg-gray-300">
                    ...
                    <!-- Corpo accordion -->
                    <div x-show="open" x-transition class="px-4 py-4 rounded-xl dark:bg-gray-700 bg-gray-300">
                        <form action="{{ route('admin.update-teacher-courses', $teacher->id) }}" method="POST">
                            ...
                            <div class="flex flex-wrap gap-4">
                                @foreach ($courses as $course)
                                    <label
                                        class="flex items-center min-w-[200px] dark:text-white dark:bg-gray-800 bg-gray-300 p-2 rounded">
