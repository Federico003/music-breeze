<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <x-primary-button onclick="window.location.href='{{ route('admin.create-teacher') }}'"> Aggiungi Insegnante </x-primary-button>
        </div>
    </x-slot>
                            ...
                            <tr class="hover:bg-orange-300 dark:hover:bg-gray-700 transition">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        {{-- Modifica --}}
                                        <a href="{{ route('admin.edit-user', ['id' => $teacher->id]) }}"
                                            title="Modifica"
                                        ...
                                        {{-- Stampa --}}
                                        <a href="{{ route('admin.print-user', ['id' => $teacher->id]) }}"
                                            title="Stampa"
                                        ...
                                        {{-- Elimina --}}
                                        <form action="{{ route('admin.delete-user', ['id' => $teacher->id]) }}"
                                            method="POST"
