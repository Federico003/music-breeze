            ...
            <form method="POST" action="{{ route('admin.update-user', ['id' => $user->id]) }}">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="birth_date" class="block mt-1 w-full" type="date" name="birth_date"
                        :value="old('birth_date', $user->birth_date ? $user->birth_date->format('Y-m-d') : '')" required autofocus autocomplete="birth_date" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="birth_place" class="block mt-1 w-full" type="text" name="birth_place"
                        :value="old('birth_place', $user->birth_place)" required autofocus autocomplete="birth_place" />
                    <x-input-error :messages="$errors->get('birth_place')" class="mt-2" />
                </div>

                <div class="mt-4">
                    <x-input-label for="gender" :value="__('Sesso')" />
                    <x-select-input id="gender" name="gender" :options="[
                        'M' => 'Maschio',
                        'F' => 'Femmina',
                        'X' => 'Non specificato',
                    ]" :value="old('gender', $user->gender)" required />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="country" class="block mt-1 w-full" type="text" name="country"
                        :value="old('country', $user->country)" required autofocus autocomplete="country" />
