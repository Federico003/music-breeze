                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-3">
                                        {{-- Modifica --}}
                                        <a href="{{route('admin.edit-user', ['id' => $student->id])}}" title="Modifica"
                                            class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-600 p-2 m-2">
                                            <x-heroicon-s-pencil class="w-5 h-5" />
                                        </a>

                                        {{-- Stampa --}}
                                        <a href="{{route('admin.print-user', ['id' => $student->id])}}" title="Stampa"
                                        ...
                                        {{-- Elimina --}}
                                        <form action="{{route('admin.delete-user', ['id' => $student->id])}}" method="POST"
